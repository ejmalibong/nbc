				...
				<div class="card">
					<form action="" method="get">
							...
							<div class="row">
								<?php if(!isset($_GET['print'])){ ?>
									<div class="col-4">
										...
										<?php	} else{ if(isset($_GET['86d178a053b97f10a65771b2c1ff9621'])){ alert("cashier", "No record found"); }	} }	?>
									</div>							
								<div class="col-3">
														...
														if($stmt->execute() === TRUE){
															...
															if($result->num_rows > 0){
																while($row = $result->fetch_object()){
																	...
																	echo '<tr>';
																		echo '<td><a href = "cashier?del='.$row->product_id.'&product_id='.$row->product_id.'&86d178a053b97f10a65771b2c1ff9621='.$_GET['86d178a053b97f10a65771b2c1ff9621'].'&barcode=a&qty=1&transact=&checkout=" class = "btn btn-sm btn-danger"><i class="fa fa-times-circle"></i><span></a></td>';
						...
						<div class="card-footer" <?php if(isset($_GET['print'])){ $transact = "go"; echo ' style = "display: none"; '; } ?>>
							...
							<?php //if($transact == "go"){ ?>								
								<a href = "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>" id = "sub_but" <?php if(!isset($_GET['checkout']) || !isset($_GET['86d178a053b97f10a65771b2c1ff9621'])){ ?> style="display: none;" name = "transact" <?php } ?> type="submit" <?php echo $onclick; ?>  class="btn btn-info btn-block btn-sm">
									<i class="fa fa-dot-circle-o"></i>&nbsp;<span>Save</span>
								</a>
								<a href = "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&print<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>" id = "sub_but_print" <?php if(!isset($_GET['checkout']) || !isset($_GET['86d178a053b97f10a65771b2c1ff9621'])){ ?> style="display: none;" name = "transact" <?php } ?> type="submit" <?php echo $onclick; ?>  class="btn btn-info btn-block btn-sm">
	...
	<script type="text/javascript">
		$(document).on('click','#isload',function(){	
			if(document.getElementById('isload').checked) {
				$("#sub_but").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>");
				$("#sub_but_print").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&print<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>");
			} else {
				$("#sub_but").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>");
				$("#sub_but_print").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&print<?php echo (isset($lunch) && $lunch != '' ? '&lunch=1' : '');?><?php echo (isset($breakfast) && $breakfast != '' ? '&breakfast=1' : '');?>");
			}
		});
	</script>
<?php } ?>
     	...
     	if($('#breakfast').is(':visible')){
	     	if (keycode == 115){
	        	 if (!$('#breakfast').is(':checked')) {
			        ...
			        $("#sub_but").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&breakfast=1");
					$("#sub_but_print").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&print&breakfast=1");
			    }else{
			    	$('#breakfast').prop('checked', false);
			        $("#sub_but").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1");
					$("#sub_but_print").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&print");
			    }
	     	}
	    }
     	if($('#lunch').is(':visible')){
     		if (keycode == 115){
	        	if (!$('#lunch').is(':checked')) {
			        ...
			        $("#sub_but").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&lunch=1");
					$("#sub_but_print").attr("href", "cashier?86d178a053b97f10a65771b2c1ff9621=<?php echo $_GET['86d178a053b97f10a65771b2c1ff9621'];?>&barcode=&qty=&transact=go&checkout=&isload=1&print&lunch=1");
			    }else{
